...
public sealed class InvalidConverterTests : AnalyzerTestBase
{
    ...
    [Fact]
    public void Converter_InternalParameterType_EmitsFKF221()
    {
        const string source = """
            using FreakyKit.Forge;
            namespace TestNs
            {
                ...
                public class Source { public InternalSource Value { get; set; } = new(); }
                public class Dest   { public string Value { get; set; } = ""; }
                ...
                public static partial class MyForges
                {
                    ...
                    [ForgeConverter]
                    public static string ConvertInternal(InternalSource value) => "converted";
                }
            }
            """;
    ...
    [Fact]
    public void Converter_InternalReturnType_EmitsFKF221()
    {
        const string source = """
            using FreakyKit.Forge;
            namespace TestNs
            {
                ...
                public class Dest   { public InternalDest Value { get; set; } = new(); }
                ...
                public static partial class MyForges
                {
                    ...
                    [ForgeConverter]
                    public static InternalDest ConvertToInternal(string value) => new();
                }
            }
            """;
