...
public sealed class ForgeMapAttribute : Attribute
{
    ...
    /// <summary>
    /// When set to <see cref="ForgePolicy.True"/>, the assignment is wrapped in a null check: the destination member
    ...
    /// When set to <see cref="ForgePolicy.Inherit"/> (default), inherits from <see cref="ForgeMethodAttribute.IgnoreIfNull"/>.
    /// </summary>
    ...
    /// mutable collection members. When set to <see cref="ForgePolicy.True"/>, this member is reference-shared
    /// regardless of the method-level setting. When set to <see cref="ForgePolicy.False"/>, this member is
    /// copy-constructed regardless of the method-level setting. When set to <see cref="ForgePolicy.Inherit"/> (default),
    /// inherits from <see cref="ForgeMethodAttribute.ShareReference"/>.
    ///
