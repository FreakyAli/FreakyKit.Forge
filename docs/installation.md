...
Install `FreakyKit.Forge.Diagnostics` directly only if you're writing your own Roslyn analyzer or source generator that needs to reference Forge's diagnostic IDs (FKF001–FKF502):
